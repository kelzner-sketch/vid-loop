      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-8 px-8 bg-[#3b917b]/6">
            ...
            <p className="text-xs text-muted-foreground/60 text-center max-w-xs bg-[hsl(var(--popover))]">Works in browser — opens front or rear camera. On iPhone, use Safari for full access.
